...
import { LimitsStore } from "../src/limitsStore.js";
...
export async function makeHarness(kind: Adapter, env: Env = {}): Promise<Harness> {
  ...
  const METHOD: Record<Route, string> = { judge: "POST", vote: "POST", usage: "GET", health: "GET", export: "GET", stats: "GET", clients: "GET", weights: "GET", scoring: "GET", manifest: "GET", adminManifest: "GET", tuner: "GET", simulate: "POST", limits: "GET", devices: "GET", review: "POST", events: "GET", posts: "GET" };
  return {
    ctx,
    db,
    clock,
